...
INSERT INTO `alert_configuration_history` VALUES (1,1,'{\n	\"alertmanager_config\": {\n		\"route\": {\n			\"receiver\": \"grafana-default-email\",\n			\"group_by\": [\"grafana_folder\", \"alertname\"]\n		},\n		\"receivers\": [{\n			\"name\": \"grafana-default-email\",\n			\"grafana_managed_receiver_configs\": [{\n				\"uid\": \"\",\n				\"name\": \"email receiver\",\n				\"type\": \"email\",\n				\"settings\": {\n					\"addresses\": \"<example@email.com>\"\n				}\n			}]\n		}]\n	}\n}\n','ed091fbc8c639dd8063190127c806946','v1',1740739983,1,1741167513);
...
INSERT INTO `cache_data` VALUES ('id-token-1-user-1',_binary 'eyJhbGciOiJFUzI1NiIsImtpZCI6ImlkLTIwMjUtMDMtZXMyNTYiLCJ0eXAiOiJqd3QifQ..Vhtm0ZoSVk85QIfeJ-r7uBv3_B9Zx_hnaM94dw_jTrr1PKGH-m_QpvVP5URab4E0UeQvr-h9AX2Tt1eWLtcBEw',569,1741172236);
...
INSERT INTO `data_source` VALUES (1,1,20,'mysql','mysql','proxy','mysql_container:3306','','grafanaReader','',0,'','',1,'{\"allowCleartextPasswords\":false,\"connMaxLifetime\":14400,\"database\":\"bi\",\"maxIdleConns\":100,\"maxIdleConnsAuto\":true,\"maxOpenConns\":100,\"tlsAuth\":false,\"tlsAuthWithCACert\":false,\"tlsSkipVerify\":false}','2025-02-28 10:57:06','2025-03-03 15:35:07',0,'{\"password\":\"I1pXVmxjR0ZrWVcweloyMWlhMlEjKllXVnpMV05tWWcqQjFyNFNOdEJxI4KuOCGZk31D7dJQaWQxyAehJRntVV2p\"}',0,'ceef55gwno3r4b',0,'');
...
INSERT INTO `role` VALUES (1,'managed:builtins:viewer:permissions','',0,1,'deef55gxk4s8wc','2025-02-28 10:57:06','2025-02-28 10:57:06','','',0),(2,'managed:builtins:editor:permissions','',0,1,'beef55gxrmha8e','2025-02-28 10:57:06','2025-02-28 10:57:06','','',0);
...
INSERT INTO `secrets` VALUES (1,1,'mysql','datasource','I1pXVmxjR0ZrWVcweloyMWlhMlEjKllXVnpMV05tWWcqNjNMQTJyaEV8mO1zgDJAqqsUKastk//wuizeboLBS1XM5Lg4zrzoaoNsVFzqJ+84','2025-02-28 10:57:06','2025-03-03 15:35:07');
...
INSERT INTO `server_lock` VALUES (1,'cleanup expired auth tokens',3,1741167466),(3,'delete old login attempts',22,1741172313);
...
INSERT INTO `user` VALUES (1,0,'admin','admin@localhost','','ad16ca271cf2d0d7d411a041c55f170f174cc10e011483183d77a5e4e7e6b82fc5a94383c45096af8f41c6f6741b072b40ad','SDMaLyxhMz','gPjJnID7Te','',1,1,0,'','2025-02-28 10:53:01','2025-02-28 10:53:01',0,'2025-03-05 10:57:16',0,0,'eeef4sd4ujuo0f');
...
INSERT INTO `user_auth_token` VALUES (1,1,'24d3a9604d6110457045476499d06d18e520f2ba449c377866ec24a725af9299','e0405bac90424ae06c7c62b37166233cd7e2e9437563eb3237fd9b444a07be89','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/133.0.0.0 Safari/537.36','10.89.0.7',0,0,1741172236,1740740212,1740740212,0,0);
...
-- Dump completed on 2025-03-05 11:04:51
